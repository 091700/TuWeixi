...
public class AiIntegrationService {
     ...
     * 召唤 AI 2：评估暗黑料理指数
     */
    // 参数从 List<Integer> 改成 List<String>
    public Double predictHarmony(List<Map<String,String>> ingredients) {
        String url = aiEngineUrl + "/api/ai/predict_harmony";
        
        Map<String, Object> request = new HashMap<>();
        // ⚠️ 极其关键：这里的 key 必须是 "ingredients"，不能是 "categories"！
        ...
        try {
            ...
            System.err.println("AI 2 预测失败！请检查 Python 引擎。");
        }
        return 50.0; // 保底分数
    }
    /**
