...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form action="${pageContext.request.contextPath}/stock-out" method="post">
                ...
                <div class="form-group">
                    <label>出库数量:</label>
                    <input type="number" name="quantity" class="form-control" min="1" max="${goods.stockQuantity}" required placeholder="输入正整数值">
                </div>
